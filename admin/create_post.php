...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO posts (title, content, status, created_at) VALUES (?, ?, ?, NOW())");
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <p class="text-gray-600 mt-1">Add a new blog post to your website</p>
            </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="content" 
                                      id="content" 
                                      required 
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition"></textarea>
                        </div>
                    </div>
