    ...
    <div class="container-xxl py-3">
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <div class="contact-card bg-white rounded-4 p-4 p-lg-5 shadow-sm">
                        <div class="contact-header mb-4 pb-3 border-bottom">
                            <h6 class="text-info mb-2 fw-semibold letter-spacing-1 small">GET IN TOUCH</h6>
                            <h1 class="mb-3 fw-bold h3">Let's Discuss Your Project</h1>
                            <p class="mb-0 text-muted">Ready to transform your water and energy solutions? Contact our team of experts for professional consultation and customized project proposals.</p>
                        </div>
                        
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <div class="contact-item d-flex align-items-start p-3 rounded-3 hover-lift">
                                    <div class="contact-icon bg-primary bg-opacity-10 rounded-3 d-flex align-items-center justify-content-center me-3 flex-shrink-0">
                                        <i class="fas fa-map-marker-alt text-primary"></i>
                                    </div>
                                    <div>
                                        <h6 class="mb-1 fw-semibold small">Our Office</h6>
                            ...
                            <div class="col-md-6">
                                <div class="contact-item d-flex align-items-start p-3 rounded-3 hover-lift">
                                    ...
                                    <div>
                                        <h6 class="mb-1 fw-semibold small">Call Us</h6>
                                        <p class="mb-0 text-muted small">+254 718897204<br>Mon - Sat, 8:00 - 18:00</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="contact-item d-flex align-items-start p-3 rounded-3 hover-lift">
                                    ...
                                    <div>
                                        <h6 class="mb-1 fw-semibold small">Email Us</h6>
                            ...
                            <div class="col-md-6">
                                <div class="contact-item d-flex align-items-start p-3 rounded-3 hover-lift">
                                    ...
                                    <div>
                                        <h6 class="mb-1 fw-semibold small">Business Hours</h6>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control border-2 rounded-3" id="name" placeholder="Your Name" style="height: 50px">
                                        <label for="name" class="text-muted small">Full Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" class="form-control border-2 rounded-3" id="email" placeholder="Your Email" style="height: 50px">
                                        <label for="email" class="text-muted small">Email Address</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control border-2 rounded-3" id="phone" placeholder="Phone Number" style="height: 50px">
                                        <label for="phone" class="text-muted small">Phone Number</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <select class="form-select border-2 rounded-3" id="service" style="height: 20px">
                                        ...
                                        <label for="service" class="text-muted small">Service Type</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control border-2 rounded-3" placeholder="Project Details" id="message" style="height: 80px"></textarea>
                                        <label for="message" class="text-muted small">Project Details & Requirements</label>
                                    </div>
                                </div>
                                <div class="col-12 pt-3">
                                    <button class="btn btn-primary w-100 py-2 rounded-3 fw-semibold shadow-sm hover-lift" type="submit">
                ...
                <div class="col-lg-6" id="contactmap">
                    <div class="map-container rounded-4 overflow-hidden shadow-sm" style="height: 800px; width:900px; border-radius:10px">
