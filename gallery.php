            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2">
                        <?php
                        try {
                            // Fetch 6 most recent gallery items
                            $stmt_footer = $pdo->prepare("SELECT image FROM gallery_items WHERE image IS NOT NULL ORDER BY created_at DESC LIMIT 6");
                            $stmt_footer->execute();
                            $footer_images = $stmt_footer->fetchAll();
                            foreach ($footer_images as $img):
                        ?>
                        <div class="col-4">
                            <img class="img-fluid rounded" src="admin/uploads/<?php echo htmlspecialchars($img['image']); ?>" alt="">
                        </div>
                        <?php 
                            endforeach;
                        } catch (PDOException $e) {
